...
public class GeoGroupBroadcastReceiver extends BroadcastReceiver {
    ...
    public static final int ACTION_CODE_USER_MESSAGE_RECEIVED = 2;
    public static final int ACTION_CODE_USER_JOINED_GROUP = 3;
    public static final int ACTION_CODE_USER_LEFT_GROUP = 4;
